...
img2 = cv.imread('im2.png')

# 1.5 Detect and Track Features (Subtask 3.1)
# Detect features in the first image
p0 = detect_features(img1)

# Track those features into the second image
pts1_tracked, pts2_tracked = track_features(img1, img2, p0)

# Reshape them slightly if needed to match the shape expected by your eight_point algorithm (N, 2)
pts1 = pts1_tracked.reshape(-1, 2)
pts2 = pts2_tracked.reshape(-1, 2)
